...
This example shows how to implement the Titan model with Gluon NLP Toolkit.
"""
...
from gluonnlp.model.titan import get_titan_encoder_decoder, ParallelTitan
...
parser.add_argument('--channels', type=int, default=8,
                    help='number of channels in covattention')
...
parser.add_argument('--save_dir', type=str, default='titan_out',
...
encoder, decoder = get_titan_encoder_decoder(units=args.num_units,
...
model = NMTModel(src_vocab=src_vocab, tgt_vocab=tgt_vocab, encoder=encoder, decoder=decoder,
                 ...
                 tie_weights=args.dataset != 'TOY', embed_initializer=None, prefix='titan_')
...
rescale_loss = 100
parallel_model = ParallelTitan(model, label_smoothing, loss_function, rescale_loss)
