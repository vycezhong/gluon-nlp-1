...
from parallel_gnmt import get_parallel_gnmt_encoder_decoder
from translation import NMTModel, MixBeamSearchTranslator
from loss import MixSoftmaxCEMaskedLoss
...
parser.add_argument('--initial_w', type=float, default=0.1, help='Width of uniform distribution')
...
encoder, decoder = get_parallel_gnmt_encoder_decoder(hidden_size=args.num_hidden,
