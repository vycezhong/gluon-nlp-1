...
from mxnet.gluon.data.dataloader import DataLoader, _MultiWorkerIter, _as_in_context,  _recursive_fork_recordio
...
class ShardedDataLoader(DataLoader):
    ...
    def __iter__(self):
        ...
        return _MultiWorkerIter(self._num_workers, self._dataset,
                                ...
                                self._pin_memory, worker_loop)# or more contributor license agreements.  See the NOTICE file
